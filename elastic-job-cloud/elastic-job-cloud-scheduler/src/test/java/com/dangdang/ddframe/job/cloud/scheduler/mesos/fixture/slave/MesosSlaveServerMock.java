...
public class MesosSlaveServerMock {
    ...
    public JsonObject state() throws JSONException {
        return (JsonObject) new JsonParser().parse("{\"version\":\"1.1.0\",\"build_date\":\"2017-02-27 10:51:31\",\"build_time\":1488163891.0,\"build_user\":\"gaohon"
                + "gtao\",\"start_time\":1488179767.60204,\"id\":\"d8701508-41b7-471e-9b32-61cf824a660d-S0\",\"pid\":\"slave(1)@1"
                + "92.168.96.45:5051\",\"hostname\":\"192.168.96.45\",\"resources\":{\"disk\":416050.0,\"mem\":6883.0,\"gpus\":0.0,\""
                ...
                + ":{},\"master_hostname\":\"192.168.96.45\",\"flags\":{\"appc_simple_discovery_uri_prefix\":\"http:\\/\\/\",\"appc_"
                ...
                + "er_backend\":\"copy\",\"initialize_driver_logging\":\"true\",\"ip\":\"192.168.96.45\",\"isolation\":\"cgroups\\/cpu"
                ...
                + "ver_timeout\":604800.0,\"checkpoint\":false,\"role\":\"*\",\"hostname\":\"192.168.121.67\",\"executors\":[{\"id\":\""
                ...
                + "{\"ip_addresses\":[{\"ip_address\":\"192.168.96.45\"}]}]}}]},{\"id\":\"cpu_job_1@-@0@-@READY@-@d8701508-41b7-"
                ...
                + "[{\"ip_addresses\":[{\"ip_address\":\"192.168.96.45\"}]}]}}]},{\"id\":\"cpu_job_1@-@2@-@READY@-@d8701508-41b7"
